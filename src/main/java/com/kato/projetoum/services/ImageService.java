...
import com.kato.projetoum.services.exceptions.FileException;
...
public class ImageService {
	...
	public BufferedImage getJpgImageFromFile(MultipartFile uploadFile) {
		...
		if (!"png".equals(ext) && !"jpg".equals(ext)) {
			throw new FileException("São permitidas somente imagens PNG e JPG");
		}
		...
		try {
			...
			throw new FileException("Erro na leitura de imagem");
		}
